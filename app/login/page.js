...
function MyApp() {
    ...
    return (
        <div className="h-full  bg-gradient-to-tl bg-zinc-100 w-full flex justify-center">
            <form className=" mb-5 desktop:w-2/4 laptop:w-2/4 tablet:w-11/12 mobail:w-11/12 max-w-6xl" action={handleSubmit}>
                <div className="flex flex-col items-center justify-center ">
                    ...
                    <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                        ...
                        <p className="text-sm mt-4 font-medium leading-none text-gray-500">
                            Dont have account?{" "}
                            <span tabIndex={0} onClick={() => router.push("/register")} aria-label="Sign up here" className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer">
                                {" "}
                                Sign up here
                            </span>
                        </p>
                        ...
                        <div>
                            ...
                            <input aria-label="enter email adress" onChange={(e) => setEmail(e.target.value)} value={email} name="email" role="input" type="email" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                            <div className={`h-2  `}>
                                {eAlert ? (
                        ...
                        <div className="mt-6  w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input aria-label="enter Password" onChange={(e) => setPassword(e.target.value)} value={password} name="password" role="input" type="password" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
